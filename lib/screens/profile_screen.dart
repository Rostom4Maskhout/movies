...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  final List<String> avatars = [
    ...
    "assets/avatars/gamer (4).png",
    "assets/avatars/gamer (5).png",
    "assets/avatars/gamer (6).png",
    "assets/avatars/gamer (7).png",
    "assets/avatars/gamer (8).png",
    "assets/avatars/gamer (9).png",
  ];
